...
class DataProcessor:
    ...
    def __init__ (self,train_path,test_path,processed_dir,config_dir):
    ...
    def balance_data(self,df):
        try:
            ...
            raise CustomException("Error data balancing step",e)
    ...
    def select_feature(self,df):
        try:
            ...
            num_features_to_selcet=self.config["data_processing"]["no_of_features"]

            top_10_features=top_features_importance_df["feature"].head(num_features_to_selcet).values
    ...
    def save_data(self,df,file_path):
        try:
            ...
            raise CustomException("Error while while saving the data ",e)
