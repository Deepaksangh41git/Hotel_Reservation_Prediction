...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.info(f"CSV file is sucessfully downladed to {RAW_FILE_PATH}")

        except Exception as e:
            logger.error("Error while downlaoding csv file ")
    ...
    def split_data(self):
        try:
            ...
            logger.error("Error while data splitting process")
    ...
    def run(self):
        try:
            ...
            logger.error("Data ingestion couldn't be completed becasuse of error")
